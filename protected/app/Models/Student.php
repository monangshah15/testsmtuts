...
class Student extends Model{
    ...
    protected $fillable = array('i_user_id','v_first_name','v_last_name','v_email','i_school_id','i_batch_id','v_parent_name','v_mobile_number','v_nick_name','v_address','e_status');
