function empty(e) {
    ...
    t.html5imageupload.prototype = {
        _init: function() {
            ...
            if (n.options.onAfterInitImage) n.options.onAfterInitImage.call(n)
            $(i).next().val('');
        },
        _bind: function() {
            var e = this;
        ...
        handleFile: function(e, n) {
            ...
            if (i.removeurl != null && !empty(t(n).data("name"))) {
                t.ajax({
                    ...
                    success: function(e) {
                        if (r.options.onAfterRemoveImage) r.options.onAfterRemoveImage.call(r, e)
                    }
                })
            }
        ...
        readImage: function(e, n, r, i) {
            ...
            a.onload = function(e) {
                ...
                s.image = t(f).clone().data({
                    ...
                    useWidth: h,
                    useHeight: p
                }).addClass("main").mousedown(function(e) {
                    s.imageHandle(e)
                });
        ...
        imageHandle: function(e) {
            ...
            var s = i.outerHeight(),
                o = i.outerWidth(),
                u = i.offset().top + s - e.pageY,
                a = i.offset().left + o - e.pageX;
            i.on({
                mousemove: function(e) {
                    var f = e.pageY + u - s,
                        l = e.pageX + a - o;
                    var c = t(r).outerWidth() != t(r).innerWidth();
                    if (parseInt(f - t(r).offset().top) > 0) {
                        f = t(r).offset().top + (c ? 1 : 0)
                    } else if (f + s < t(r).offset().top + t(r).outerHeight()) {
                        f = t(r).offset().top + t(r).outerHeight() - s + (c ? 1 : 0)
                    }
                    if (parseInt(l - t(r).offset().left) > 0) {
                        l = t(r).offset().left + (c ? 1 : 0);
                    } else if (l + o < t(r).offset().left + t(r).outerWidth()) {
                        l = t(r).offset().left + t(r).outerWidth() - o + (c ? 1 : 0);
                    }
                    i.offset({
                        top: f,
                        left: l
        ...
        imageUnhandle: function() {
            var e = this;
            var n = e.image;
            t(n).unbind("mousemove");
            if (e.options.onAfterMoveImage) e.options.onAfterMoveImage.call(e)
        },
        ...
        imageReset: function() {
            ...
            e._ghost();
            if (e.options.onAfterResetImage) e.options.onAfterResetImage.call(e)
        },
        imageFinal: function() {
            var e = this;
            var n = e.element;
            ...
            if (e.options.onAfterProcessImage) e.options.onAfterProcessImage.call(e)
        },
        ...
        reset: function() {
            ...
            if (i.removeurl != null && !empty(t(n).data("name"))) {
                t.ajax({
                    ...
                    success: function(t) {
                        if (e.options.onAfterRemoveImage) e.options.onAfterRemoveImage.call(e, t)
                    }
                })
            }
            t(n).data("name", null);
            ...
            if (s.buttonZoomin != false) {
                t(i).append(t(n.button.zoomin).on({
                    ...
                    mouseup: function(t) {
                        ...
                        if (n.options.onAfterZoomImage) n.options.onAfterZoomImage.call(n)
                    },
    ...
    t.fn.html5imageupload = function(e) {
        ...
        return t(this).each(function() {
            new t.html5imageupload(e, this);
            t.data(this, "html5imageupload")
        })
    }
})(window, jQuery)