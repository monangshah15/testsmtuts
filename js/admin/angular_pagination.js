 ...
 *
 */
angular.module('adminGridApp').directive('paging', function () {
    ...
    function setScopeValues(scope, attrs) {
        ...
        scope.scrollTop = scope.$eval(attrs.scrollTop)| true;
    ...
    return {
        ...
        controller: function($scope, $http, $timeout , filerAPI ){
            $scope.api = filerAPI;
            $scope.$watch('filter_record', filter_current_data)
            function filter_current_data()
            {
                    
            }
        },
        template: 
			'<ul ng-hide="Hide" class="pagination" ng-class="ulClass"> ' +
				'<li ' +
				'title="{{Item.title}}" ' +
